...
<picture>
  <source media="(max-width: 820px)" srcset="../assets/diagrams/cap09-iceberg-requerimiento-mobile.svg">
  <img src="../assets/diagrams/cap09-iceberg-requerimiento.svg" alt="El pedido visible oculta usuario, propósito, datos, volumen, permisos, flujo posterior y criterios de éxito.">
</picture>
...
| Lo que recuerdan o resumen | Lo que la observación puede revelar |
|---|---|
| «Uso el sistema todos los días» | La tarea ocurre dos veces por semana |
| «El proceso es simple» | Cinco notas contienen atajos indispensables |
| «Exporto y lo envío» | Limpian columnas, reformatean, convierten y recién entonces envían |
...
Un boceto de exportación podría mostrar rango de fechas, departamento, formato
y acción principal. Su función no es definir el diseño final, sino provocar
preguntas concretas: «¿faltan filtros?», «¿quién puede exportar?» y «¿qué ocurre
con un volumen grande?».
...
<picture>
  <source media="(max-width: 820px)" srcset="../assets/diagrams/cap09-descubrimiento-contraste-mobile.svg">
  <img src="../assets/diagrams/cap09-descubrimiento-contraste.svg" alt="Conversar, observar, revisar evidencia y prototipar aportan perspectivas distintas que deben sintetizarse.">
</picture>
...
1. «Necesito un reporte de ventas diario por email» → ¿para qué?
2. «Para saber cómo van las ventas» → ¿qué decisión exige revisarlas a diario?
3. «Para detectar problemas rápido» → ¿qué clase de problema?
4. «Un producto deja de venderse y no nos damos cuenta» → ¿por qué no se detecta?
5. «Hay muchos productos y no tenemos alertas» → ¿qué señal permitiría actuar?

La exploración sugiere una alternativa: alertar cuando un producto cae de forma
significativa respecto de su comportamiento esperado, en lugar de enviar otro
reporte que alguien debe inspeccionar manualmente. El umbral exacto todavía es
un supuesto que necesita datos y validación.
...
⚠️ **Advertencia**: No presentes como acordado un documento generado por IA sin
revisarlo con las personas implicadas. Un requisito mal interpretado puede
propagarse al diseño, la implementación y las pruebas. Confirma decisiones,
supuestos y preguntas abiertas mediante una fuente humana responsable.
...
**Anterior**: [Desarrollo Asistido por IA](./08-desarrollo-asistido-ia.md) | **Siguiente**: [Diseño de Producto y UX](./10-diseno-producto-ux.md)
